...
namespace CarRent.Infrastructure.Migrations
{
    ...
    [Migration("20250213093401_Initial_Migration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarRent.Domain.Entities.Payment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("CarRent.Domain.Entities.Payment", b =>
                {
                    b.HasOne("CarRent.Domain.Entities.Booking", "Booking")
                        .WithOne("Payment")
                        .HasForeignKey("CarRent.Domain.Entities.Payment", "BookingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CarRent.Domain.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
